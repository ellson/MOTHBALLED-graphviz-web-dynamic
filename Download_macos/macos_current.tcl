...
foreach {package platforms} $packages_platforms {
    ...
    puts $fout "The current development release seems to install cleanly"
    puts $fout "on OSX 10.6 (Snow Leopard). Please report any bugs in the"
    puts $fout "usual way (website or mail form to gviz-bugs)."
    puts $fout "<tbody>"
    puts $fout "<tr>"
