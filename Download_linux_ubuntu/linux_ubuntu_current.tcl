...
set platform_directory_type_comments {
    UB13.10.x86_64 ubuntu/ub13.10/x86_64 {amd64.deb all.deb} "Ubuntu 13.10 (Raring Ringtail)"
    UB13.10.i386 ubuntu/ub13.10/i386 {i386.deb all.deb} "Ubuntu 13.10 (Raring Ringtail)"
